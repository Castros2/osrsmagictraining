...
profit = (10*sapphireBoltsePrice) - (10*sapphireBoltsPrice + enchantSapphireRunes)
print("profit: " + str(profit))
print("cost/xp: " + str(profit/17))
print()
...
profit = (10*emeraldBoltsePrice) - (10*emeraldBoltsPrice + enchantEmeraldRunes)
print("profit: " + str(profit))
print("cost/xp: " + str(profit/37))
print()
...
profit = (10*topazBoltsePrice) - (10*topazBoltsPrice + enchantTopazRunes)
print("profit: " + str(profit))
print("cost/xp: " + str(profit/33))
print()
...
profit = (10*rubyBoltsePrice) - (10*rubyBoltsPrice + enchantRubyRunes)
print("profit: " + str(profit))
print("cost/xp: " + str(profit/59))
print()
...
profit = (10*diamondBoltsePrice) - (10*diamondBoltsPrice + enchantDiamondRunes)
print("profit: " + str(profit))
print("cost/xp: " + str(profit/67))
print()
...
profit = (10*dragonBoltsePrice) - (10*dragonBoltsPrice + enchantDragonRunes)
print("profit: " + str(profit))
print("cost/xp: " + str(profit/78))
print()
...
profit = (10*onyxBoltsePrice) - (10*onyxBoltsPrice + enchantOnyxRunes)
print("profit: " + str(profit))
print("cost/xp: " + str(profit/97))
print()